...
// 	rootDir: srcDir,
// 	components: function() {
// 		return glob.sync(srcDir + '/components/**/*.js').filter(function(module) {
// 			const isSpec = /\.spec\.js$/.test(module);
//       const isUtil = /\.util\/(.*)\.js$/.test(module) || /util\/(.*)\.js$/.test(module); 
...
// 		});
// 	},
// 	styleguidDir: buildDir,
// 	title: 'JLab Clone of Fullstack.io React component cookbook',
